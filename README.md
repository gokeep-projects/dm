<h1 align="center">⚡ DM</h1>

<p align="center">
  <strong>Linux 现场维护中枢</strong><br/>
  <em>单一二进制 · 零外部依赖 · 完全离线运行</em>
</p>
...
<p align="center">
  <code>OBSERVE ──► DIAGNOSE ──► EXECUTE ──► VERIFY ──► RECORD</code>
</p>
...
| 📜 | **维护脚本** | 用户/内置脚本 · 分类筛选 · 上传执行 · 历史追溯 |
| ⚙️ | **服务管理** | 进程识别 · 端口映射 · systemd 管理 · 健康检查 |
...
├──────────┬──────────┬──────────┬──────────┬─────────────┤
│ Checks   │ Scripts  │  Docs    │ Traffic  │ Java        │
├──────────┴──────────┴──────────┴──────────┴─────────────┤
...
| 文件 | 路径 |
|:---|:---|
| PID | `~/.dm/logs/dm-serve-<port>.pid` |
| 日志 | `~/.dm/logs/dm-serve-<port>.log` |
...
dm java export --pid 12345 --format raw    -o raw.json      # 原始数据
dm java export --pid 12345 --format report -o report.md     # Markdown 报告
dm java export --pid 12345 --format pdf    -o report.pdf    # PDF 报告
```
